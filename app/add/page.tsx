        ...
        <main className="min-h-screen p-6">
            ...
            {tab === "shirt" && (
                <form onSubmit={handleAddShirt} className="flex flex-col gap-3 w-64">
                    ...
                    <button className="bg-blue-600 text-white py-2 rounded">Add Shirt</button>
                </form>
            )}
            ...
            {tab === "short" && (
                <form onSubmit={handleAddShort} className="flex flex-col gap-3 w-64">
                    ...
                    <button className="bg-blue-600 text-white py-2 rounded">Add Short</button>
                </form>
            )}
            ...
            {tab === "frock" && (
                <form onSubmit={handleAddFrock} className="flex flex-col gap-3 w-64">
                    ...
                    <button className="bg-blue-600 text-white py-2 rounded">Add Frock</button>
                </form>
            )}
